            ...
            <div class="my-auto">
                <form id="review-form" action="includes/review-helper.php" method="POST">
                    ...
                    <div class="form-group" style="margin-top: 15px;">
                        ...
                        <textarea class="form-control" id="review-text" name="review" cols="50" rows="3" placeholder="Enter review..."></textarea>
                        <input type="hidden" name="rating" id="rating">
                        <input type="hidden" name="item_id" value="'.$_GET['id'].'">
                    </div>
                    <div class="form-group">
                        <button class="btn btn-outline-danger" id="review-submit" name="review-submit" type="submit" style="width:100%;">Submit</button>
                    </div>
                </form>
            </div>
        </div>
